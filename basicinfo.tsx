...
const yourName : String = "Eric Tlaseca - Morales";
let yourPronouns : String = "He/Him";
const yourMajor : String = "Computer Science";
let classification : String = "soph";
let oneExcite : String = "Improving web dev skills";
let anyConcerns : String = "As of right now, not much, just want to do well in the class";
let funFact : String = "I have two German ShepardsS";
